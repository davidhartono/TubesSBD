            ...
            <div class="card-body" style="background: color #f9eea9;">
                ...
                <form action="/register/create" method="POST">
                    ...
                    <div class="input-group flex-nowrap py-2">
                        <label for="name" class="input-group-text" id="addon-wrapping"><i
                                class="bi bi-person"></i></label>
                        <input type="name" name="name" class="form-control" placeholder="Name" aria-label="name"
                            aria-describedby="addon-wrapping" value="{{ Session::get('name') }}">
                    </div>
                    <div class="input-group flex-nowrap py-2">
                    ...
                    <div class="input-group flex-nowrap py-2">
                        <label for="passwordconfirm" class="input-group-text" id="addon-wrapping"><i
                                class="bi bi-lock"></i></label>
                        <input type="password" name="password_confirmation" class="form-control" placeholder="Password confirmation"
                            aria-label="passwordconfirm" aria-describedby="addon-wrapping">
                    </div>
                    <div class="flex-nowrap py-2 d-flex justify-content-between">
                        <a href="/login" class="btn btn-outline-secondary">Login</a>
                        <button type="submit" name="submit" class="btn btn-warning text-white">Register</button>
                    </div>
                </form>
